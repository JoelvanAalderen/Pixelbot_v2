...
def run_bot_part(sim_id, bot_part, pixel_size, Placement, mass_values, stiffness_values, A_values, n_pixel_types, period, dt, t_final, start_p_position, start_p_angle, save_folder="solutions/walker_grid_search/flat_ground/0001_06max(natural_omega)/"):
    if not bot_part:
    ...
    for n, (bot_id, omega_sim, phi_sim) in enumerate(bot_part):
        ...
        def ground_func_for_bot(points=shifted_points, vectors=shifted_vectors):
            return points, vectors
